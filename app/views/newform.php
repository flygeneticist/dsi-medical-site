            ...
            <form action="formsubmition.php" method="post">
                <div id="group1">
                    <div class="textborder form-group">
                        ...
                        <label>Date of APM:</label><input type="date" name="dateofapm" maxlength=20 required/><br/>
                        <label>Contractor First Name:</label><input type="text" name="contractorFirstName" size=20 required/><br/>
                        <label>Contractor Last name:</label><input type="text" name="contractorLastName" size=20 required/><br/>
                        <label>Job Number (XXXXXXXXXX):</label><input type="text" name="JobID" size=10 minlength=10 maxlength=10 required/><br/>
                        <label>FSR-PO#:</label><input type="text" name="fsrponum" size=10 maxlength=15 required/><br/>
                        <label>Billable?</label><select name="billable"><option value=1>Yes</option><option value=0>No</option></select><br/>
                        <label>Jobsite Name:</label><input type="text" name="jobsitename" size=30 required/><br/>
                        <label>Number of Tests (Approximate):</label><input type="number" size=4 min="1" name="numoftests" required/><br/>
                        <label>Jobsite Address:</label><input type="text" name="jobsiteaddress" size=40 required/><br/>
                        <label>City:</label><input type="text" name="jobsitecity" size=20 required/><br/>
                        <label>State:</label><input type="text" name="jobsitestate" size=2 maxlength=2 required/><br/>
                        <label>Zip Code:</label><input type="text" name="jobsitezip" size=5 maxlength=5 required/><br/>
                    </div>
                </div>
                ...
                <div id="group3" style="clear:both;">
                    <div class="textborder form-group">
                        ...
                        <label>Type Of Testing:</label><select name="typeoftesting"><option>Pre_Employment</option><option>Random</option><option>Other</option></select><br/>
                    </div>
                </div>
